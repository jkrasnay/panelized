/*
 * EffReg Popup JQuery Plug-in
 *
 * This is a JQuery plugin that implements pop-up dialog functionality in the
 * EffReg app. The requirements are has follows:
 *
 ...
 * Usage:
 *
 * $('#myModal').effRegModal('show');
 *
 * $('#myModal').effRegModal('hide');
 *
 */
